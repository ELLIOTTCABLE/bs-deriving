...
module T : sig
  ...
  type var0 = A0 of int [@@ppx.deriving map,show]

  type 'a var1 = A1 of 'a [@@ppx.deriving map,show]

  type 'a var2 = A2 of 'a | B2 of int [@@ppx.deriving map,show]

  type ('a,'b) var3 = A3 of 'a | B3 of bool | C3 of 'b * ('a,'b) var3 [@@ppx.deriving map,show]

  type record0 = { a0 : int } [@@ppx.deriving map,show]

  type 'a record1 = { a1 : 'a } [@@ppx.deriving map,show]

  type 'a record2 = { a2 : 'a; b2 : int } [@@ppx.deriving map,show]

  type ('a,'b) record3 = { a3 : 'a; b3 : bool; c3 : 'b } [@@ppx.deriving map,show]

  type ('a,'b) pvar0 = [ `A of 'a | `B of ('a,'b) pvar0 | `C of 'b ] [@@ppx.deriving map,show]
  type ('a,'b,'c) pvar1 = [ ('a,'b) pvar0 | `D of 'c | `E of ('b,'c) pvar0 ] [@@ppx.deriving map,show]
  type pvar2 = [ `F | `G ] [@@ppx.deriving map,show]
  type ('a,'b,'c) pvar3 = [ pvar2 | ('a,'b,'c) pvar1 ] [@@ppx.deriving map,show]
...
#if OCAML_VERSION >= (4, 03, 0)
type 'a result0 = ('a, bool) result [@@ppx.deriving show,map]
...
type 'a result_result0 = ('a, bool) Result.result [@@ppx.deriving show,map]
